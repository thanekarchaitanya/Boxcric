      ...
      <div className="w-full max-w-[320px] bg-[#141414] border border-white/10 rounded-[2rem] overflow-hidden shadow-3xl animate-in zoom-in-95 duration-200">
        <div className="p-7 text-left">
          ...
          <div className="space-y-6">
            <div className="space-y-2 text-left">
              ...
              <input 
                ...
                className="w-full bg-[#1A1A1A] border border-white/5 rounded-xl px-4 py-3.5 text-xs text-white font-bold outline-none shadow-inner text-left"
              />
            </div>
            ...
            <div className="space-y-3 text-left">
              ...
              <div className="flex items-center justify-between bg-[#1A1A1A] border border-white/5 rounded-xl p-2 shadow-inner">
                ...
                <div className="flex flex-col items-center">
                  <span className="text-xl font-black text-white italic leading-none">{overs}</span>
                </div>
                <button 
                  onClick={() => adjustOvers(1)}
          ...
          <div className="mt-10 flex gap-3">
            <button 
              onClick={onClose}
              className="flex-1 py-4 bg-[#1A1A1A] text-white/30 rounded-xl font-black text-[9px] uppercase tracking-[0.3em] transition-all active-scale"
            >
              Cancel
            </button>
            <button 
